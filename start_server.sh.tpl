...
if [[ $CROSSPLAY = true ]] then
	box64 ./valheim_server.x86_64 -nographics -batchmode -name "$SERVER_NAME" -port 2456 -public $PUBLIC -world "$WORLD_NAME" -password "$SERVER_PASS" -savedir "$SAVE_DIR" -crossplay
else 
